...
class PhoneNumber {
	...
	/**************************************************************************/
	getCountryCodeIndex(strippedNumber) {
		return -1;
	}
	 ...
	 */
	validateInternational(countryCodeIndex, strippedNumber) {
		return null;
	}

	/**************************************************************************/
	validateNorthAmerican(countryCodeIndex, strippedNumber) {
		return extractPhoneBody(countryCodeIndex, strippedNumber).length() ===
			10
			? null
			: this.REASONS[1];
	}
	...
	/**************************************************************************/
	extractPhoneBody(countryCodeIndex, strippedNumber) {
		return null;
	}

	/**************************************************************************/
	getValueAsNorthAmerican(countryCodeIndex, stripped) {
		return null;
	}

	/**************************************************************************/
	getValueAsInternational(countryCodeIndex, stripped) {
		return null;
	}

	/**************************************************************************/
	getValueAsNorthAmerican() {
		return getValueAsNorthAmerican(
	...
	/**************************************************************************/
	getValueAsInternational() {
		return getValueAsInternational(
			this.countryCodeIndex,
			this.strippedValue
		);
	}
	...
	isNorthAmericanNumber() {
		return this.countryCodeIndex === this.USA;
	}
